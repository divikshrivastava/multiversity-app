...
{ id: '1831', name: 'Charles Darwin', whatIf: 'What if Darwin had never sailed on the HMS Beagle?', imageUrl: '/images/darwin.jpeg', scenarios: ["Without his voyage on the HMS Beagle, Charles Darwin turned his boundless curiosity towards the culinary arts, revolutionizing cooking by introducing the theory of \"Survival of the Tastiest.\" His experiments led to the creation of self-evolving recipes that adapt to taste buds over time. The first person to set foot on the Moon is Chef Gusto, the inventor of zero-gravity molecular gastronomy, in the year 2067.","Darwin, having never embarked on the Beagle, became a playwright specializing in dramas about the social lives of barnacles and finches. His plays, mistaken for profound allegories about society, inspired a global movement to elect animals as political leaders. The first creature to set foot on the Moon is Sir Quacks-a-Lot, the duck President of the United Earth, in the year 2099"], scenarioImages: [['/scenarios/charles/1.webp', '/scenarios/charles/2.webp', '/scenarios/charles/3.webp'], ['/scenarios/charles/4.webp', '/scenarios/charles/5.webp', '/scenarios/charles/6.webp']] },
 { id: '44 BC', name: 'Julius Caesar', whatIf: 'What if Caesar had not been assassinated on the Ides of March?', imageUrl: '/images/Julius.jpeg', scenarios: [], scenarioImages: [['/scenarios//1.webp', '/scenarios//2.webp', '/scenarios//3.webp'], ['/scenarios//4.webp', '/scenarios//5.webp', '/scenarios//6.webp']] },
{ id: '1933', name: 'Albert Einstein', whatIf: 'What if Einstein had stayed in Germany during the rise of the Nazis?', imageUrl: '/images/Albert.jpeg', scenarios: [], scenarioImages: [['/scenarios//1.webp', '/scenarios//2.webp', '/scenarios//3.webp'], ['/scenarios//4.webp', '/scenarios//5.webp', '/scenarios//6.webp']] },
{ id: '387 BC', name: 'Plato', whatIf: 'What if Plato had never founded the Academy in Athens?', imageUrl: '/images/Plato.jpeg', scenarios: [] , scenarioImages: [['/scenarios//1.webp', '/scenarios//2.webp', '/scenarios//3.webp'], ['/scenarios//4.webp', '/scenarios//5.webp', '/scenarios//6.webp']]},
...
{ id: '500', name: 'King Arthur', whatIf: 'What if the legends of King Arthur were based on a true historical figure?', imageUrl: '/images/King.jpeg', scenarios: [], scenarioImages: [['/scenarios//1.webp', '/scenarios//2.webp', '/scenarios//3.webp'], ['/scenarios//4.webp', '/scenarios//5.webp', '/scenarios//6.webp']] },
{ id: '1903', name: 'Nikola Tesla', whatIf: 'What if Tesla had succeeded in building his Wardenclyffe Tower project?', imageUrl: '/images/Nikola.jpeg', scenarios: [], scenarioImages: [['/scenarios/Nikola/1.webp', '/scenarios//2.webp', '/scenarios//3.webp'], ['/scenarios//4.webp', '/scenarios//5.webp', '/scenarios//6.webp']] },
];
...
function App() {
  ...
  const toggleOrder = () => {
    setEvents(isTimelineOrder ? pevents : pevents);
  ...
  return (
    <div className="app-container">
      ...
      <div className="scenario-label">
            {"Select a person from our list, then select a scenario from that what if multiverse, and then view the wonderful history of that world, culminating at the Canon event of Moon Landing!"}
          </div>
